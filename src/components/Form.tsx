    ...
    <div className="bg-cyan-600 rounded-lg p-4 m-6 max-w-sm bg-opacity-25 backdrop-blur-lg">
        ...
        <form action="" method="POST"> 
            <div className="p-2"><i className="fa-solid fa-user pt-5 pl-2 absolute text-slate-500"></i>
                <input required className='w-full h-14 rounded-md pl-8' type="text" placeholder="Nome completo"/>
            </div>
            <div className="p-2"><i className="fa-solid fa-phone pt-5 pl-2 absolute text-slate-500"></i>
                <input required className='w-full h-14 rounded-md pl-8' type="tel" placeholder="(11) 91234-5678"/>
            </div>
            <div className="p-2"><i className="fa-solid fa-envelope pl-2 pt-5 absolute text-slate-500"></i>
                <input required className='w-full h-14 rounded-md pl-8' type="email" placeholder="email@dominio.com"/>
            </div>
            <div className="p-2">
                <textarea required className='w-full rounded-md p-4 h-32 resize-none' placeholder="Mensagem"/>
            </div>
            <div className="p-2">
